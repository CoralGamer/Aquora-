...
3. **[Fase 3: Ecosistema Web: Portal Open Source & Dashboard de Control (Sprint 2)](file:///E:/AQUORA/Fases%20de%20Desarrollo/03_Fase_Ecosistema_Web_y_Visor_3D.md)**
   ...
   * **[Fase 3.5: Rediseño Visual, Expansión Open Source y Ajuste de Resiliencia (Fase Intermedia)](file:///E:/AQUORA/Fases%20de%20Desarrollo/03.5_Fase_Ajuste_Visual_Firmware_y_Resiliencia.md)**:
     * *Alcance:* Refinamiento visual del portal web y Landing Page inspirado en el diseño premium *minimalist dark landscape* con acentos de umbral carmesí finos, ampliación de la documentación técnica del firmware C++ para Arduino IDE con código y FAQ extendidos, y ruta de activos visuales organizada.
